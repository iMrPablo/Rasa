...
.calendar-day.today.has-sale::after {
...
html[dir="ltr"] #printArea .invoice-table td {
text-align: left;
}
#printArea .invoice-table th {
background: #000;
...
#printArea .total-row.final .total-amount {
color: #000;
font-size: 16px;
}
}
...
<div class="subtitle" data-i18n="subtitle">نسخه 2 - طراح و توسعه دهنده : آقای پابلو</div>
</div>
...
fa: 'fa-IR', en: 'en-US', fr: 'fr-FR', de: 'de-DE', es: 'es-ES', en_GB: 'en-GB'
};
...
fa: {
appName: 'پنل رسا',
subtitle: 'نسخه 2 - طراح و توسعه دهنده : آقای پابلو',
tabSettings: 'تنظیمات',
...
tabHistory: 'تاریخچه',
tabCalendar: 'تقویم',
settingsTitle: 'اطلاعات فروشگاه',
storeNameLabel: 'نام فروشگاه',
phoneLabel: 'شماره تماس',
addressLabel: 'آدرس',
saveSettings: 'ذخیره تنظیمات',
exportBackup: 'دانلود پشتیبان',
currencyLabel: 'واحد پول',
languageLabel: 'زبان',
calendarLabel: 'تقویم',
vatLabel: 'ارزش افزوده',
vatPercentLabel: 'ارزش افزوده (٪)',
installerTitle: 'نصب پنل رسا',
installerSubtitle: 'تنظیمات اولیه را انتخاب کنید',
installButton: 'نصب',
...
invoiceTitle: 'ساخت فاکتور',
invoiceIdLabel: 'آیدی فاکتور',
invoiceNumberLabel: 'شماره فاکتور',
categoryFilterLabel: 'فیلتر دسته‌بندی',
allCategories: 'همه دسته‌بندی‌ها',
selectProduct: 'انتخاب محصول',
manualProductNameLabel: 'نام محصول دستی',
manualProductCategoryLabel: 'دسته‌بندی محصول دستی',
noCategory: 'بدون دسته‌بندی',
manualPriceLabel: 'قیمت دستی',
manualOnlyLabel: 'فقط محصول دستی',
quantityLabel: 'تعداد',
addToInvoice: 'افزودن به فاکتور',
discountLabel: 'تخفیف',
discountTypeLabel: 'نوع تخفیف',
discountAmountType: 'مبلغی',
discountPercentType: 'درصدی',
totalLabel: 'جمع کل',
payableLabel: 'قابل پرداخت',
recordSale: 'ثبت فروش',
saveInvoiceList: 'ذخیره',
newInvoice: 'جدید',
repeatLast: 'تکرار',
printInvoice: 'چاپ',
customerNameLabel: 'نام مشتری',
customerPhoneLabel: 'شماره مشتری',
invoiceNoteLabel: 'یادداشت فاکتور',
deleteLabel: 'حذف',
historyTitle: 'تاریخچه فروش',
todayLabel: 'امروز',
thisWeekLabel: 'این هفته',
thisMonthLabel: 'این ماه',
reportTypeLabel: 'نوع گزارش',
reportCalendarLabel: 'تقویم گزارش',
dayReport: 'روز',
weekReport: 'هفته',
monthReport: 'ماه',
yearLabel: 'سال',
...
emptySales: 'هنوز فروشی ثبت نشده است',
emptyReport: 'فروشی در این بازه ثبت نشده است',
row: 'ردیف',
category: 'دسته‌بندی',
...
discount: 'تخفیف',
payable: 'قابل پرداخت',
reportTitle: 'گزارش فروش',
invoiceTitlePrint: 'فاکتور فروش',
printDate: 'تاریخ چاپ',
invoiceDate: 'تاریخ',
customerLabel: 'مشتری',
noteLabel: 'یادداشت',
settingsSaved: 'تنظیمات ذخیره شد',
backupExported: 'پشتیبان دانلود شد',
...
invoiceEmpty: 'فاکتور خالی است',
saleRecorded: 'فروش با موفقیت ثبت شد',
invoiceSaved: 'لیست فاکتور ذخیره شد',
reportEmpty: 'گزارشی برای چاپ وجود ندارد',
confirmDeleteCategory: 'این دسته‌بندی حذف شود؟',
confirmDeleteProduct: 'این محصول حذف شود؟',
confirmNewInvoice: 'فاکتور جدید شروع شود؟',
confirmRecordSale: 'فاکتور ثبت شود؟',
error: 'خطا',
salesWord: 'فروش',
invoiceHistoryTitle: 'تاریخچه فاکتورها',
searchPlaceholder: 'جستجو با شماره یا آیدی فاکتور...',
noInvoiceFound: 'فاکتوری یافت نشد',
printSale: 'چاپ',
storeSignLabel: 'مهر و امضای فروشگاه',
panelFooter: 'پنل مدیریت فروش رسا',
dateTimeLabel: 'تاریخ و ساعت',
calendar_jalali: 'تقویم شمسی',
calendar_gregorian: 'تقویم میلادی',
calendar_both: 'هر دو تقویم',
currency_USD: 'دلار',
currency_EUR: 'یورو',
...
language_en_gb: 'انگلیسی (UK)'
},
en: {
appName: 'Panel Rasa',
subtitle: 'Version 2 - Designer & Developer: Mr. Pablo',
...
settingsTitle: 'Store Information',
...
vatLabel: 'VAT',
vatPercentLabel: 'VAT (%)',
installerTitle: 'Install Panel Rasa',
installerSubtitle: 'Choose initial settings',
...
manualProductNameLabel: 'Manual product name',
manualProductCategoryLabel: 'Manual product category',
noCategory: 'No category',
manualPriceLabel: 'Manual price',
manualOnlyLabel: 'Manual only',
quantityLabel: 'Quantity',
addToInvoice: 'Add to invoice',
discountLabel: 'Discount',
discountTypeLabel: 'Discount type',
discountAmountType: 'Amount',
discountPercentType: 'Percent',
totalLabel: 'Subtotal',
payableLabel: 'Payable',
recordSale: 'Record sale',
saveInvoiceList: 'Save',
newInvoice: 'New',
repeatLast: 'Repeat',
printInvoice: 'Print',
...
reportCalendarLabel: 'Report calendar',
dayReport: 'Day',
weekReport: 'Week',
monthReport: 'Month',
yearLabel: 'Year',
...
emptyReport: 'No sales found for this period.',
row: 'Row',
category: 'Category',
...
invoiceTitlePrint: 'Sales Invoice',
...
invoiceSaved: 'Invoice list saved.',
reportEmpty: 'No report to print.',
confirmDeleteCategory: 'Delete this category?',
confirmDeleteProduct: 'Delete this product?',
confirmNewInvoice: 'Start a new invoice?',
confirmRecordSale: 'Record this sale?',
error: 'Error',
salesWord: 'sales',
invoiceHistoryTitle: 'Invoice History',
searchPlaceholder: 'Search by invoice number or ID...',
noInvoiceFound: 'No invoice found',
printSale: 'Print',
storeSignLabel: 'Store stamp & signature',
panelFooter: 'Rasa Sales Management Panel',
dateTimeLabel: 'Date & time',
calendar_jalali: 'Jalali calendar',
calendar_gregorian: 'Gregorian calendar',
calendar_both: 'Both calendars',
currency_USD: 'US Dollar',
currency_EUR: 'Euro',
currency_OMR: 'Omani Rial',
currency_IRT: 'Iran Toman',
currency_IRR: 'Iran Rial',
language_fa: 'Persian',
language_en: 'English',
language_fr: 'French',
language_de: 'German',
...
fr: {
appName: 'Panel Rasa',
subtitle: 'Version 2 - Concepteur et développeur : M. Pablo',
...
settingsTitle: 'Informations de la boutique',
...
vatLabel: 'TVA',
vatPercentLabel: 'TVA (%)',
installerTitle: 'Installation de Panel Rasa',
installerSubtitle: 'Choisissez les paramètres initiaux',
...
categoryFilterLabel: 'Filtre de catégorie',
allCategories: 'Toutes les catégories',
selectProduct: 'Sélectionner un produit',
manualProductNameLabel: 'Nom de produit manuel',
manualProductCategoryLabel: 'Catégorie du produit manuel',
noCategory: 'Sans catégorie',
manualPriceLabel: 'Prix manuel',
manualOnlyLabel: 'Manuel uniquement',
quantityLabel: 'Quantité',
addToInvoice: 'Ajouter à la facture',
discountLabel: 'Remise',
discountTypeLabel: 'Type de remise',
discountAmountType: 'Montant',
discountPercentType: 'Pourcentage',
totalLabel: 'Total',
payableLabel: 'À payer',
recordSale: 'Enregistrer',
saveInvoiceList: 'Sauvegarder',
newInvoice: 'Nouveau',
repeatLast: 'Répéter',
...
reportCalendarLabel: 'Calendrier du rapport',
dayReport: 'Jour',
weekReport: 'Semaine',
monthReport: 'Mois',
yearLabel: 'Année',
...
prev: 'Précédent',
next: 'Suivant',
jalaliCalendar: 'Solaire',
gregorianCalendar: 'Grégorien',
emptySales: 'Aucune vente.',
emptyReport: 'Aucune vente.',
row: 'Ligne',
category: 'Catégorie',
productName: 'Produit',
unitPrice: 'Prix unit.',
...
noLastInvoice: 'Aucune facture.',
categoryRequired: 'Nom requis.',
productFields: 'Champs requis.',
quantityValid: 'Quantité invalide.',
chooseOrManual: 'Sélectionnez ou entrez.',
invoiceEmpty: 'Vide.',
saleRecorded: 'Enregistré.',
invoiceSaved: 'Sauvegardé.',
reportEmpty: 'Vide.',
confirmDeleteCategory: 'Supprimer?',
confirmDeleteProduct: 'Supprimer?',
confirmNewInvoice: 'Nouveau?',
confirmRecordSale: 'Enregistrer?',
error: 'Erreur',
salesWord: 'ventes',
...
printSale: 'Imprimer',
storeSignLabel: 'Cachet et signature du magasin',
panelFooter: 'Panneau de gestion des ventes Rasa',
dateTimeLabel: 'Date',
calendar_jalali: 'Solaire',
calendar_gregorian: 'Grégorien',
calendar_both: 'Les deux',
currency_USD: 'Dollar',
currency_EUR: 'Euro',
currency_OMR: 'Rial omanais',
currency_IRT: 'Toman',
currency_IRR: 'Rial',
language_fa: 'Persan',
language_en: 'Anglais',
...
language_en_gb: 'Anglais (UK)'
},
de: {
appName: 'Panel Rasa',
subtitle: 'Version 2 - Designer & Entwickler: Herr Pablo',
...
settingsTitle: 'Shopinformationen',
...
vatLabel: 'MwSt.',
vatPercentLabel: 'MwSt. (%)',
installerTitle: 'Installation',
installerSubtitle: 'Einstellungen wählen',
installButton: 'Installieren',
currencyLockedNote: 'Währung gesperrt',
categoriesTitle: 'Kategorien',
categoryNameLabel: 'Name',
addCategory: 'Hinzufügen',
emptyCategories: 'Keine.',
...
manualProductNameLabel: 'Name',
manualProductCategoryLabel: 'Kategorie',
noCategory: 'Keine',
manualPriceLabel: 'Preis',
manualOnlyLabel: 'Nur manuell',
quantityLabel: 'Menge',
addToInvoice: 'Hinzufügen',
discountLabel: 'Rabatt',
discountTypeLabel: 'Typ',
discountAmountType: 'Betrag',
discountPercentType: 'Prozent',
totalLabel: 'Summe',
payableLabel: 'Zahlbar',
recordSale: 'Buchen',
saveInvoiceList: 'Speichern',
newInvoice: 'Neu',
repeatLast: 'Wiederholen',
printInvoice: 'Drucken',
customerNameLabel: 'Kunde',
customerPhoneLabel: 'Telefon',
invoiceNoteLabel: 'Notiz',
deleteLabel: 'Löschen',
...
reportTypeLabel: 'Typ',
reportCalendarLabel: 'Berichtskalender',
dayReport: 'Tag',
weekReport: 'Woche',
monthReport: 'Monat',
yearLabel: 'Jahr',
...
payable: 'Zahlbar',
reportTitle: 'Bericht',
invoiceTitlePrint: 'Rechnung',
printDate: 'Datum',
invoiceDate: 'Datum',
customerLabel: 'Kunde',
noteLabel: 'Notiz',
settingsSaved: 'Gespeichert.',
backupExported: 'Heruntergeladen.',
noLastInvoice: 'Keine.',
categoryRequired: 'Name erforderlich.',
productFields: 'Felder erforderlich.',
quantityValid: 'Ungültig.',
chooseOrManual: 'Auswählen.',
invoiceEmpty: 'Leer.',
saleRecorded: 'Erfasst.',
invoiceSaved: 'Gespeichert.',
reportEmpty: 'Leer.',
confirmDeleteCategory: 'Löschen?',
confirmDeleteProduct: 'Löschen?',
confirmNewInvoice: 'Neu?',
confirmRecordSale: 'Buchen?',
error: 'Fehler',
salesWord: 'Verkäufe',
invoiceHistoryTitle: 'Rechnungshistorie',
searchPlaceholder: 'Suchen...',
noInvoiceFound: 'Nicht gefunden',
printSale: 'Drucken',
storeSignLabel: 'Stempel & Unterschrift des Shops',
panelFooter: 'Rasa Verkaufsverwaltungs-Panel',
dateTimeLabel: 'Datum',
...
language_en_gb: 'Englisch (UK)'
},
es: {
appName: 'Panel Rasa',
subtitle: 'Versión 2 - Diseñador: Sr. Pablo',
tabSettings: 'Ajustes',
...
settingsTitle: 'Información',
storeNameLabel: 'Nombre',
phoneLabel: 'Teléfono',
addressLabel: 'Dirección',
saveSettings: 'Guardar',
exportBackup: 'Descargar',
currencyLabel: 'Moneda',
languageLabel: 'Idioma',
calendarLabel: 'Calendario',
vatLabel: 'IVA',
vatPercentLabel: 'IVA (%)',
installerTitle: 'Instalación',
installerSubtitle: 'Configuración inicial',
installButton: 'Instalar',
currencyLockedNote: 'Moneda bloqueada',
categoriesTitle: 'Categorías',
categoryNameLabel: 'Nombre',
addCategory: 'Añadir',
emptyCategories: 'Vacío.',
...
invoiceIdLabel: 'ID',
invoiceNumberLabel: 'N° Factura',
categoryFilterLabel: 'Filtro',
allCategories: 'Todas',
selectProduct: 'Producto',
manualProductNameLabel: 'Nombre',
manualProductCategoryLabel: 'Categoría',
noCategory: 'Sin categoría',
manualPriceLabel: 'Precio',
manualOnlyLabel: 'Solo manual',
quantityLabel: 'Cantidad',
addToInvoice: 'Añadir',
discountLabel: 'Descuento',
discountTypeLabel: 'Tipo',
discountAmountType: 'Monto',
discountPercentType: 'Porcentaje',
totalLabel: 'Total',
payableLabel: 'A pagar',
recordSale: 'Registrar',
saveInvoiceList: 'Guardar',
newInvoice: 'Nuevo',
repeatLast: 'Repetir',
printInvoice: 'Imprimir',
customerNameLabel: 'Cliente',
customerPhoneLabel: 'Teléfono',
invoiceNoteLabel: 'Nota',
...
reportCalendarLabel: 'Calendario del informe',
dayReport: 'Día',
weekReport: 'Semana',
monthReport: 'Mes',
yearLabel: 'Año',
...
payable: 'A pagar',
reportTitle: 'Informe',
invoiceTitlePrint: 'Factura',
printDate: 'Fecha',
invoiceDate: 'Fecha',
customerLabel: 'Cliente',
noteLabel: 'Nota',
settingsSaved: 'Guardado.',
backupExported: 'Descargado.',
noLastInvoice: 'Ninguna.',
categoryRequired: 'Requerido.',
productFields: 'Requerido.',
quantityValid: 'Inválido.',
chooseOrManual: 'Seleccionar.',
invoiceEmpty: 'Vacío.',
saleRecorded: 'Registrado.',
invoiceSaved: 'Guardado.',
reportEmpty: 'Vacío.',
confirmDeleteCategory: '¿Eliminar?',
confirmDeleteProduct: '¿Eliminar?',
confirmNewInvoice: '¿Nuevo?',
confirmRecordSale: '¿Registrar?',
error: 'Error',
salesWord: 'ventas',
invoiceHistoryTitle: 'Historial de facturas',
searchPlaceholder: 'Buscar...',
noInvoiceFound: 'No encontrado',
printSale: 'Imprimir',
storeSignLabel: 'Sello y firma de la tienda',
panelFooter: 'Panel de gestión de ventas Rasa',
dateTimeLabel: 'Fecha',
calendar_jalali: 'Solar',
...
return languageLocales[appData.settings.language || 'fa'] || 'fa-IR';
}
function gregorianCalendarLocale() {
return appData.settings.language === 'fa' ? 'en-US' : currentLocale();
}
...
return Number(value || 0).toLocaleString(currentLocale(), { maximumFractionDigits: 2 });
}
function formatNumber(value) {
return Number(value || 0).toLocaleString(currentLocale(), { maximumFractionDigits: 0 });
}
function formatDayNumber(value) {
return Number(value || 0).toLocaleString(currentLocale(), { useGrouping: false });
}
...
return t('currency_' + (appData.settings.currency || 'IRT'));
}
...
return formatPrice(value) + ' ' + invoiceCurrencyLabel();
}
...
await api('toggle_theme', { theme: newTheme });
}
}
...
if (showAlert) alert(t('settingsSaved'));
} else if (showAlert) {
...
alert((result && result.error) || t('error'));
}
}
...
else alert(result.error || t('error'));
}
...
function syncCalendarDependents() {
renderSalesTable();
...
calendar: 'jalali', installed: false, currency_locked: false, vat: 0, theme: 'light'
}, result.settings);
...
function generateInvoiceIdLocal() {
return 'RSA-ID-' + Date.now().toString(36).toUpperCase();
}
...
if (!name) { alert(t('categoryRequired')); return; }
...
if (!payload.name || !payload.category || payload.price === '') { alert(t('productFields')); return; }
...
if (!quantity || quantity < 1) { alert(t('quantityValid')); return; }
let item = null;
if (!manualOnlyEnabled && selectedId) {
const product = appData.products.find(function (productItem) { return productItem.id === selectedId; });
if (product) {
item = { name: product.name, category: product.category || '', price: Number(product.price), quantity: quantity };
}
} else {
const manualPrice = parseFloat(manualPriceValue);
if (manualName && !isNaN(manualPrice) && manualPrice >= 0) {
item = { name: manualName, category: manualCategory || '', price: manualPrice, quantity: quantity };
}
}
if (!item) { alert(t('chooseOrManual')); return; }
...
if (!appData.sales || !appData.sales.length) { alert(t('noLastInvoice')); return; }
const last = appData.sales[0];
invoiceItems = Array.isArray(last.items) ? JSON.parse(JSON.stringify(last.items)) : [];
invoiceDiscount = Number(last.discount_value || last.discount || 0);
invoiceDiscountType = last.discount_type || 'amount';
invoiceCustomerName = last.customer_name || '';
invoiceCustomerPhone = last.customer_phone || '';
invoiceNote = last.note || '';
...
if (showAlert) {
if (result.ok) alert(t('invoiceSaved'));
else alert(result.error || t('error'));
}
return result;
}
async function recordSale() {
if (!invoiceItems.length) { alert(t('invoiceEmpty')); return; }
...
const monthLength = calendarMode === 'gregorian' ? gregorianMonthLength(jy, jm) : jalaliMonthLength(jy, jm);
dayEl.innerHTML = '';
...
if (!currentReport.filtered.length) { alert(t('reportEmpty')); return; }
let rows = '';
...
note: invoiceNote,
extraLines: getPanelDateTimeLines()
});
window.print();
}
loadData();
